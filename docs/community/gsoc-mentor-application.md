...
virtualization, the KVM hypervisor for full system virtualization, Crossbow for
virtualized networks, a high-performance kernel CIFS/SMB client and server,
